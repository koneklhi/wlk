...
| [GOAL_LANGLOCK_STAGE0_SAMPLE_EXPANSION.md](GOAL_LANGLOCK_STAGE0_SAMPLE_EXPANSION.md) | 언어잠금 환각(`docs/backlog/LANG_LOCK_STAGE0_HANDOFF.md`) 안 A(단일언어 세션 오탐률 표본 확대, 코드변경 0) 실행 → 안전하면 자율로 안 B(Stage 1 섀도우 게이트, 실제 적용 없음)까지, 위험 신호면 정지·보고 | 미실행 — 신규 작성(2026-07-21) |
