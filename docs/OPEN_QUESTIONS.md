...
- 메시지 스키마 **확정·구현 완료**(후보 A: `whisperlivekit` 출력 + `completed` / `lang` 등 React 호환 별칭 유지). 정본 = [SCHEMA_CHANGES.md](SCHEMA_CHANGES.md) / [FRONTEND_HANDOFF.md](FRONTEND_HANDOFF.md).
