...
- **[E4·채택][언어][base전용·재검증]** `periodic_lang_check`(PLC) **기본값 4.0 채택(Exp-154)** — 전환세금 제거·배선 완료(Exp-151/153) 후 재평가에서 ytn2 무휴지 en→ko 전환을 잡아 median 개선·filler 소멸. E1/E2 3회기각(Exp-131/143/145)은 전환세금 미제거 상태의 결론이라 무효화. PLC=None이면 언어 고착 후 환각 급증. **turbo ytn2 대폭회귀(Exp-158)와 이 파라미터의 상호작용 재검증 필요.**
